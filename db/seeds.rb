...
viandedeboeuf = Product.new(name: "5kg Viande de Boeuf AB - Variante Pot Au Feu", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus ratione molestias provident id, porro nesciunt.", weight: 1750, image_url:"assets/potaufeu.jpg", show_image_url:"potaufeu.jpg", stock: 5550, price_cents: 5000, final_price: 100), ppk:
viandedeboeuf.save
viandedeboeufhache = Product.new(name: "5kg Viande de Boeuf AB - Variante Haché", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus ratione molestias provident id, porro nesciunt.", weight: 1750, image_url:"assets/steakboeuf.png", show_image_url:"steakboeuf.png", stock: 5550, price_cents: 5000, final_price: 100), ppk:
viandedeboeufhache.save
viandedeveau = Product.new(name: "5kg Viande de Veau AB", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus ratione molestias provident id, porro nesciunt.", weight: 1750, image_url:"assets/viandedeveau.png", show_image_url:"viandedeveau.png", stock: 5550, price_cents: 5000, final_price: 125), ppk:
viandedeveau.save
...
viandeveaubcp = Product.new(name: "Colis 10kg Viande de Veau AB", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus ratione molestias provident id, porro nesciunt.", weight: 1750, image_url:"assets/viandedeveau.png", show_image_url:"viandedeveau.png", stock: 5550, price_cents: 5000, final_price: 210), ppk:
viandeveaubcp.save
